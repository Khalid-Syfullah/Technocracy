...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <!--navabar-->
    <nav class="navbar navbar-expand-lg navbar-dark shadow fixed-top" style="background-color: rgba(58, 42, 120, 0.9);">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="font-family: 'Titillium Web', sans-serif;">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu text-light" style="background-color: rgba(58, 42, 120, 0.9);" aria-labelledby="navbarDropdown">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu text-light" style="background-color: rgba(58, 42, 120, 0.9);" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item text-light" href="#">Organizing Committee</a>
                <a class="dropdown-item text-light" href="#">Campus Representatives</a>
              </div>
            </li>
            <li class="nav-item">
          ...
          <div class="row text-light" style="font-family: 'Titillium Web', sans-serif;">
            <div class="col-sm-12 col-md-6">
              <div class="embed-responsive embed-responsive-16by9 tazbinur-video" style="z-index: 2">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/Z5arGUmaA54" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
            <div class="col-sm-12 col-md-6">
          ...
          <div class="row text-light" style="font-family: 'Titillium Web', sans-serif;">
            ...
            <div class="col-sm-12 col-md-6">
              <div class="embed-responsive embed-responsive-16by9" style="margin-left: -50px; z-index: 2; box-shadow: -25px 19px 24px -13px rgba(0,0,0,0.75);
                -webkit-box-shadow: -25px 19px 24px -13px rgba(0,0,0,0.75);
                -moz-box-shadow: -25px 19px 24px -13px rgba(0,0,0,0.75);">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/ygp2H_OpmMo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
          </div>
      ...
      <div class="" id="tazbinur" style="padding-top: 50px; padding-bottom: 100px; background-color: #e7e6e6">
        <div class="container">
          ...
          <div class="row text-light text-center" style="font-family: 'Titillium Web', sans-serif;">
            <div class="col-12">
              <div class="embed-responsive embed-responsive-16by9 tazbinur-video" style="z-index: 2">
                <iframe width="100%" height="315" src="https://www.youtube.com/embed/Z5arGUmaA54" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
            <div class="col-12">
          ...
          <div class="row text-light text-center" style="font-family: 'Titillium Web', sans-serif;">
            <div class="col-12">
              <div class="embed-responsive embed-responsive-16by9 tazbinur-video" style="z-index: 2">
                <iframe width="100%" height="315" src="https://www.youtube.com/embed/ygp2H_OpmMo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
            <div class="col-12">
              <div class="card tazbinur-video-card" style="width:100% ; height: 370px; margin-top: -50px; z-index: 1;" >

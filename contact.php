...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Technocracy | Contact</title>
  ...
  <body>
    ...
    <!--logo -->
    <div class="container" style="margin-bottom: 0px; margin-top: 120px;">
      <div class="row text-center">
        <div class="col-12">
          <img src="img/technocracy_circle.png" alt="" style="width: 130px; margin-bottom: 20px">
        </div>
        <div class="col-12">
          <p class="lead">
            <text style="font-family: 'Orbitron', sans-serif; font-size: 20px; letter-spacing: 10px; color: rgb(147, 2, 164)">TECHNOCRACY 2019 <br>
            </text> <br>
          </p>
        </div>
      </div>
    ...
    <div class="text-center container" style="font-family: 'Titillium Web', sans-serif; margin-bottom: 100px">
      <p class="" style="font-size: 25px; color: rgb(168, 6, 187)">For any query contact below</p>
      <hr style="color: rgb(147, 2, 164)">

      <p><i style="letter-spacing: 2px; font-size: 15px" class="text-muted;">
        E-mail: tech.ece.ruet@gmail.com <br>
        <br>
        Phone: +880 1766 209586 <br>
        Phone: +880 1726 777707 <br>
        Phone: +880 1710 347494 <br>
        Phone: +880 1771 683431 <br>
      </p> </i>
    </div>
